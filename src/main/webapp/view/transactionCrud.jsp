...
<body>
	...
	<ul>
		...
		<li><a class="active" href="transactionCrud">Transaction
				Management</a></li>
	...
	<div class="content">
		<div id="div1">
			...
			<form name="addTrans" onsubmit="return validatefrom1()"
				action="addTransaction" method="POST"
				modelAttribute="transactionModel">
				Sender's Account : <input type="number" name="fromAcc" required /> <br>
				Reciever's Account : <input type="number" name="toAcc" required /> <br>
		...
		<div id="div2">
			...
			<br />
			<form name="readTrans" action="readTransaction"
				onsubmit="return validateform2()" method="GET"
				modelAttribute="transactionModel">
				Transaction ID : <input type="number" name="transId" required /> <br>
